"""JSON-safe value conversion helpers.

This module is intentionally small and dependency-light. It should not import
runtime configuration, database connections, HTTP clients, or domain services.
"""
